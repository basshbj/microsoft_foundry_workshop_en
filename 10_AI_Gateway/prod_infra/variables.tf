...
variable "virtual_network_address_space" {
  description = "Address space for the private workshop virtual network."
  type        = list(string)
  default     = ["10.42.0.0/16"]
}

variable "api_management_subnet_address_prefixes" {
  description = "Address prefixes for the dedicated API Management outbound integration subnet."
  type        = list(string)
